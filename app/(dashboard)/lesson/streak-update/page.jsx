...
export default function LessonPage() {
  ...
  return (
    <div className="h-[calc(100dvh_-_var(--sat))] sm:min-h-[calc(100dvh_-_64px)] lg:min-h-[100dvh] bg-background flex flex-col overflow-hidden sm:overflow-visible">
      ...
      <div
        className={`flex-1 min-h-0 flex justify-center p-3 sm:p-4 items-start overflow-x-hidden overflow-y-auto`}
      >
                    ...
                    <div className="grid grid-cols-2 gap-3 sm:gap-4">
                      {mcqOptions.map((option, index) => (
                        <motion.button
                          ...
                          className={`p-2.5 sm:p-4 md:p-6 w-full min-h-[80px] sm:min-h-[100px] rounded-lg sm:rounded-xl border-2 text-left transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center ${
              ...
              <>
                ...
                <div className="grid grid-cols-2 gap-3 sm:gap-4">
                  <motion.button
                    ...
                    disabled={isCorrect !== null}
                    className={`p-2.5 sm:p-6 md:p-8 w-full min-h-[100px] sm:min-h-[120px] rounded-xl sm:rounded-2xl border-2 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex flex-col items-center justify-center gap-2 sm:gap-3 ${
