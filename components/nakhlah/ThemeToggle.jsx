...
function SunIcon({ className }) {
  return (
    ...
    >
      <path
        fill="#fdf5a9"
        d="M50.5 28.228A21.5 21.5 0 1 0 50.5 71.22800000000001A21.5 21.5 0 1 0 50.5 28.228Z"
      />
      <path
        fill="#1f212b"
        d="M50.5 72.228c-12.407 0-22.5-10.094-22.5-22.5s10.093-22.5 22.5-22.5S73 37.322 73 49.728 62.907 72.228 50.5 72.228zM50.5 29.228c-11.304 0-20.5 9.196-20.5 20.5s9.196 20.5 20.5 20.5S71 61.032 71 49.728 61.804 29.228 50.5 29.228zM50 25.228c-.552 0-1-.447-1-1v-7c0-.553.448-1 1-1s1 .447 1 1v7C51 24.781 50.552 25.228 50 25.228zM50 83.228c-.552 0-1-.447-1-1v-7c0-.553.448-1 1-1s1 .447 1 1v7C51 82.781 50.552 83.228 50 83.228zM83 51.228h-7c-.552 0-1-.447-1-1s.448-1 1-1h7c.552 0 1 .447 1 1S83.552 51.228 83 51.228zM24 51.228h-7c-.552 0-1-.447-1-1s.448-1 1-1h7c.552 0 1 .447 1 1S24.552 51.228 24 51.228z"
      />
      <path
        fill="#1f212b"
