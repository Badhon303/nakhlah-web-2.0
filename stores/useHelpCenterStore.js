...
/**
 * Help Center Store
 * Caches the full Help Center globals doc (FAQ, learning guide, learning
 * tips). This content is managed via CMS and rarely changes, so the whole
 * document is fetched once and reused instantly by the standalone /faq and
 * /tips routes plus the in-app profile Help Center / Learning Tips screens,
 * instead of each screen re-fetching (and re-selecting) its own slice.
 * TTL: 30 minutes
 */
